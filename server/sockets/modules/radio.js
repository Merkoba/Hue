module.exports = function(handler, vars, io, db_manager, config, sconfig, utilz, logger)
{
    ...
    handler.public.change_radio_source = async function(socket, data)
    {
        ...
        if(vars.rooms[socket.hue_room_id].current_radio_source === data.src
        ...
        if(Date.now() - vars.rooms[socket.hue_room_id].last_radio_change < config.radio_change_cooldown)
        {
