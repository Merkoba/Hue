module.exports = function(handler, vars, io, db_manager, config, sconfig, utilz, logger)
{
    ...
    handler.public.change_voice_permission = function(socket, data)
    {
        ...
        handler.push_admin_log_message(socket, `changed ${data.vtype}.${data.ptype} voice permission to "${data.what}"`)
    }
    ...
    handler.public.change_op_permission = function(socket, data)
    {
        ...
        handler.push_admin_log_message(socket, `changed ${data.optype}.${data.ptype} op permission to "${data.what}"`)
    }
