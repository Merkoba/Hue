module.exports = function (c, config) {
  ...
  c.vars.radio_metadata_interval_duration =
    config.radio_metadata_interval_duration;
  ...
  c.vars.radio_domain_white_or_black_list =
    config.radio_domain_white_or_black_list;
