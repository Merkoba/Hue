...
Hue.user_settings = {
  ...
  user_join_notifications_method: {
    ...
    action: (type, save = true) => {
      Hue[type].user_join_notifications_method = $(
        `#${type}_user_join_notifications_method option:selected`
      ).val()
  ...
  save_user_join_notifications: {
    ...
    action: (type, save = true) => {
      Hue[type].save_user_join_notifications = $(
        `#${type}_save_user_join_notifications`
      ).prop("checked")
  ...
  user_part_notifications_method: {
    ...
    action: (type, save = true) => {
      Hue[type].user_part_notifications_method = $(
        `#${type}_user_part_notifications_method option:selected`
      ).val()
  ...
  save_user_part_notifications: {
    ...
    action: (type, save = true) => {
      Hue[type].save_user_part_notifications = $(
        `#${type}_save_user_part_notifications`
      ).prop("checked")
  ...
  room_notifications_method: {
    ...
    action: (type, save = true) => {
      Hue[type].room_notifications_method = $(
        `#${type}_room_notifications_method option:selected`
      ).val()
  ...
  save_room_notifications: {
    ...
    action: (type, save = true) => {
      Hue[type].save_room_notifications = $(
        `#${type}_save_room_notifications`
      ).prop("checked")
