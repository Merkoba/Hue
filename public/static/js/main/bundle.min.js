...
Hue.change_voice_permission=function(e,i){return Hue.is_admin_or_op(Hue.role)?void 0!==Hue[e]&&((!0===i||!1===i)&&(Hue[e]===i?(Hue.feedback("That permission is already set to that"),!1):void Hue.socket_emit("change_voice_permission",{ptype:e,what:i}))):(Hue.not_an_op(),!1)},Hue.announce_voice_permission_change=function(e){let i;i=e.what?`${e.username} set ${e.ptype} to true`:`${e.username} set ${e.ptype} to false`,Hue[e.ptype]=e.what,Hue.show_room_notification(e.username,i),Hue.check_permissions(),Hue.config_admin_permission_checkboxes()},Hue.change_voice_permission_command=function(e){let i=e.split(" ");if(3!==i.length)return!1;let o=i[0],s=i[1],_=i[2],n=`voice${o}_${s}_permission`;return void 0===Hue[n]?(Hue.feedback("Invalid format"),!1):"true"!==_&&"false"!==_?(Hue.feedback("Invalid value"),!1):(_=JSON.parse(_),void Hue.change_voice_permission(n,_))},Hue.start_permissions=function(e){Hue.voice1_chat_permission=e.voice1_chat_permission,Hue.voice1_image_permission=e.voice1_image_permission,Hue.voice1_tv_permission=e.voice1_tv_permission,Hue.voice1_radio_permission=e.voice1_radio_permission,Hue.voice1_synth_permission=e.voice1_synth_permission,Hue.voice2_chat_permission=e.voice2_chat_permission,Hue.voice2_image_permission=e.voice2_image_permission,Hue.voice2_tv_permission=e.voice2_tv_permission,Hue.voice2_radio_permission=e.voice2_radio_permission,Hue.voice2_synth_permission=e.voice2_synth_permission,Hue.voice3_chat_permission=e.voice3_chat_permission,Hue.voice3_image_permission=e.voice3_image_permission,Hue.voice3_tv_permission=e.voice3_tv_permission,Hue.voice3_radio_permission=e.voice3_radio_permission,Hue.voice3_synth_permission=e.voice3_synth_permission,Hue.voice4_chat_permission=e.voice4_chat_permission,Hue.voice4_image_permission=e.voice4_image_permission,Hue.voice4_tv_permission=e.voice4_tv_permission,Hue.voice4_radio_permission=e.voice4_radio_permission,Hue.voice4_synth_permission=e.voice4_synth_permission},Hue.check_permissions=function(){Hue.can_chat=Hue.check_permission(Hue.role,"chat"),Hue.can_image="enabled"===Hue.room_image_mode&&Hue.check_permission(Hue.role,"image"),Hue.can_tv="enabled"===Hue.room_tv_mode&&Hue.check_permission(Hue.role,"tv"),Hue.can_radio="enabled"===Hue.room_radio_mode&&Hue.check_permission(Hue.role,"radio"),Hue.can_synth="enabled"===Hue.room_synth_mode&&Hue.check_permission(Hue.role,"synth"),Hue.setup_footer_icons()},Hue.check_permission=function(e=!1,i=!1){return!!Hue.is_admin_or_op(e)||!!(e&&i&&Hue[`${e}_${i}_permission`])};
