...
Hue.show_role=function(){"admin"===Hue.role?Hue.feedback("You are an admin"):"op"===Hue.role?Hue.feedback("You are an op"):Hue.role.startsWith("voice")&&Hue.feedback(`You have ${Hue.role}`);let e=0;Hue.can_chat&&(Hue.feedback("You have chat permission"),e+=1),Hue.can_images&&(Hue.feedback("You have images permission"),e+=1),Hue.can_tv&&(Hue.feedback("You have tv permission"),e+=1),Hue.can_radio&&(Hue.feedback("You have radio permission"),e+=1),0===e&&Hue.feedback("You cannot interact")},Hue.show_username=function(){Hue.feedback(`Username: ${Hue.username}`)},Hue.user_join=function(e){Hue.add_to_userlist({user_id:e.user_id,username:e.username,role:e.role,profile_image:e.profile_image,date_joined:e.date_joined,bio:e.bio,hearts:e.hearts,skulls:e.skulls});let i=function(){Hue.show_profile(e.username)},t=Hue.make_info_popup_item({icon:"fa fa-user-plus",message:`${e.username} has joined`,on_click:i,type:"user_join"});if(!Hue.user_is_ignored(e.username)&&Hue.get_setting("user_join_notifications")){Hue.make_info_popup(i).show(t)}e.username!==Hue.username&&Hue.on_activity("join"),Hue.update_user_last_message(e.user_id),Hue.open_profile_username===e.username&&Hue.show_profile(e.username,$("#show_profile_image").attr("src"))},Hue.update_user_last_message=function(e){let i=Hue.get_last_chat_message_by_user_id(e);if(!i)return!1;let t=$(i).find(".chat_content").last().text();if(!t)return!1;i&&Hue.replace_property_in_userlist_by_user_id(e,"last_message",t)},Hue.update_usercount=function(){let e=`${Hue.utilz.singular_or_plural(Hue.usercount,"Users")} Online`;$("#usercount").text(e),"normal"===Hue.userlist_mode&&Hue.msg_userlist.set_title(e)},Hue.add_to_userlist=function(e={}){e=Object.assign({user_id:!1,username:!1,role:!1,profile_image:!1,date_joined:!1,bio:"",hearts:0,skulls:0,last_message:""},e);for(let i=0;i<Hue.userlist.length;i++)if(Hue.userlist[i].user_id===e.user_id)return Hue.userlist[i].user_id=e.user_id,Hue.userlist[i].username=e.username,Hue.userlist[i].role=e.role,Hue.userlist[i].profile_image=e.profile_image,Hue.userlist[i].bio=e.bio,Hue.userlist[i].hearts=e.hearts,Hue.userlist[i].skulls=e.skulls,Hue.userlist[i].last_message=e.last_message,Hue.update_userlist(),!1;return Hue.userlist.push({user_id:e.user_id,username:e.username,role:e.role,profile_image:e.profile_image,date_joined:e.date_joined,bio:e.bio,hearts:e.hearts,skulls:e.skulls,last_message:e.last_message}),Hue.update_userlist(),!0},Hue.remove_from_userlist=function(e){for(let i=0;i<Hue.userlist.length;i++)if(Hue.userlist[i].user_id===e){Hue.userlist.splice(i,1),Hue.update_userlist();break}},Hue.replace_property_in_userlist_by_username=function(e,i,t,u=!0){let s=!1;for(let u=0;u<Hue.userlist.length;u++)if(Hue.userlist[u].username===e){Hue.userlist[u][i]=t,s=!0;break}u&&s&&(Hue.update_userlist(),Hue.open_profile_username===e&&Hue.show_profile(e))},Hue.replace_property_in_userlist_by_user_id=function(e,i,t,u=!0){let s,r=!1;for(let u=0;u<Hue.userlist.length;u++)if(Hue.userlist[u].user_id===e){Hue.userlist[u][i]=t,s=Hue.userlist[u],r=!0;break}u&&r&&(Hue.update_userlist(),Hue.open_profile_username===s.username&&Hue.show_profile(s.username))},Hue.get_role=function(e){for(let i=0;i<Hue.userlist.length;i++)if(Hue.userlist[i].username===e)return Hue.userlist[i].role},Hue.reset_voices_userlist=function(){for(let e=0;e<Hue.userlist.length;e++)Hue.userlist[e].role.startsWith("voice")&&"voice1"!==Hue.userlist[e].role&&(Hue.userlist[e].role="voice1");Hue.update_userlist()},Hue.remove_ops_userlist=function(){for(let e=0;e<Hue.userlist.length;e++)"op"===Hue.userlist[e].role&&(Hue.userlist[e].role="voice1");Hue.update_userlist()},Hue.role_tag=function(e){let i;return i="admin"===e?"[A]":"op"===e?"[O]":"voice1"===e?"[V1]":"voice2"===e?"[V2]":"voice3"===e?"[V3]":"voice4"===e?"[V4]":""},Hue.get_pretty_role_name=function(e){let i;return i="admin"===e?"Admin":"op"===e?"Operator":"voice1"===e?"Voice 1":"voice2"===e?"Voice 2":"voice3"===e?"Voice 3":"voice4"===e?"Voice 4":""},Hue.get_user_by_username=function(e){for(let i of Hue.userlist)if(i.username===e)return i;return!1},Hue.get_user_by_id=function(e){for(let i of Hue.userlist)if(i.user_id===e)return i;return!1},Hue.update_userlist=function(){Hue.userlist.sort(Hue.compare_userlist),Hue.usernames=[];for(let e of Hue.userlist)Hue.usernames.push(e.username);Hue.msg_userlist.is_open()&&(Hue.update_userlist_window(),Hue.check_userlist_visibility()),Hue.usercount=Hue.userlist.length,Hue.update_usercount()},Hue.setup_userlist_window=function(){$("#userlist").on("click",".userlist_item_username, .userlist_item_profile_image, .userlist_item_bio, .userlist_item_role",function(){let e=$(this).closest(".userlist_item").find(".userlist_item_username").eq(0).text();"normal"===Hue.userlist_mode?Hue.show_profile(e):"whisper"===Hue.userlist_mode&&Hue.update_whisper_users(e)}),$("#Msg-content-container-userlist").scroll(function(){Hue.on_userlist_scroll()})},Hue.update_userlist_window=function(){let e=$();e=e.add();for(let i=0;i<Hue.userlist.length;i++){let t=Hue.userlist[i],u=$("\n        <div class='modal_item userlist_item dynamic_title'>\n            <div class='userlist_column flex_column_center'>\n                <div>\n                    <div class='userlist_item_profile_image_container round_image_container unselectable action4'>\n                        <img class='userlist_item_profile_image profile_image' src=''>\n                    </div>\n                    <div class='userlist_item_details_container'>\n                        <div class='userlist_item_username action'></div>\n                        <div class='userlist_item_role action'></div>\n                    </div>\n                </div>\n                <div class='userlist_item_bio action'></div>\n            </div>\n        </div>"),s=Hue.get_user_info_title(t);u.attr("title",s),u.data("otitle",s),u.data("date",t.date_joined);let r=u.find(".userlist_item_profile_image").eq(0);r.data("src",t.profile_image),r.data("username",t.username),r.data("src_applied",!1),r.attr("src",Hue.config.default_profile_image_url);let n=Hue.role_tag(t.role);u.find(".userlist_item_role").eq(0).text(n),u.find(".userlist_item_username").eq(0).text(t.username);let a=u.find(".userlist_item_bio").eq(0);t.bio?a.text(t.bio.substring(0,50)):a.css("display","none"),e=e.add(u)}$("#userlist").html(e),Hue.userlist_filtered&&Hue.do_modal_filter()},Hue.compare_userlist=function(e,i){return""===e.role&&(e.role="voice1"),""===i.role&&(i.role="voice1"),e.role.startsWith("voice")&&i.role.startsWith("voice")?e.role<i.role?1:e.role>i.role?-1:e.username>i.username?-1:e.username<i.username?1:0:e.role>i.role?1:e.role<i.role?-1:e.username<i.username?-1:e.username>i.username?1:0},Hue.user_is_online_by_username=function(e){let i=Hue.get_user_by_username(e);return Boolean(i)},Hue.user_is_controllable=function(e){return e.user_id===Hue.user_id||!!Hue.is_admin_or_op()&&("admin"!==e.role&&"op"!==e.role||"admin"===Hue.role)},Hue.show_userlist_window=function(e="normal",i=!1){Hue.userlist_mode=e,"normal"===e?Hue.update_usercount():"whisper"===e&&Hue.msg_userlist.set_title("Add or Remove a User"),Hue.update_userlist_window(),Hue.msg_userlist.show(function(){Hue.check_userlist_visibility(),i&&($("#userlist_filter").val(i),Hue.do_modal_filter())})},Hue.check_userlist_visibility=function(){let e=$("#Msg-window-userlist"),i=e.height(),t=e.offset().top;$(".userlist_item").each(function(){if("none"===$(this).css("display"))return!0;let e=$(this).offset().top-t;if(e>0&&e<i){let e=$(this).find(".userlist_item_profile_image").eq(0);e.data("src_applied")||(e.on("error",function(){$(this).attr("src")!==Hue.config.default_profile_image_url&&$(this).attr("src",Hue.config.default_profile_image_url)}),e.attr("src",e.data("src")),e.data("src_applied",!0))}})},Hue.sort_userlist_by_activity_trigger=function(e,i){return e.last_activity_trigger<i.last_activity_trigger?-1:e.last_activity_trigger>i.last_activity_trigger?1:0},Hue.update_user_profile_image=function(e,i){for(let t=0;t<Hue.userlist.length;t++){if(Hue.userlist[t].username===e)return void(Hue.userlist[t].profile_image=i)}},Hue.get_ignored_usernames_list=function(){let e=Hue.get_setting("ignored_usernames").split("\n");1!==e.length||e[0]||(e=[]),Hue.ignored_usernames_list=e},Hue.setup_activity_bar=function(){let e=Hue.userlist.slice(0);e.sort(Hue.sort_userlist_by_activity_trigger);for(let i of e)Hue.push_to_activity_bar(i.username,i.last_activity_trigger);setInterval(function(){Hue.check_activity_bar()},Hue.config.activity_bar_interval),setInterval(function(){Hue.app_focused&&Hue.trigger_activity()},Hue.config.activity_bar_trigger_interval),Hue.get_setting("activity_bar")?Hue.show_activity_bar():Hue.hide_activity_bar(),$("#activity_bar_container").on("click",".activity_bar_item",function(){Hue.show_profile($(this).data("username"))})},Hue.check_activity_bar=function(e=!0){if(0===Hue.activity_list.length)return!1;let i=Date.now()-Hue.config.max_activity_bar_delay,t=[],u=!1;for(let e of Hue.activity_list){let s=Hue.get_user_by_username(e.username);e.date>i&&s&&!Hue.user_is_ignored(e.username)?t.push(e):u=!0}return u&&(Hue.activity_list=t,e&&Hue.update_activity_bar()),u},Hue.toggle_activity_bar=function(){let e;Hue.get_setting("activity_bar")?(Hue.hide_activity_bar(),e=!1):(Hue.show_activity_bar(),e=!0),Hue.enable_setting_override("activity_bar"),Hue.modify_setting(`activity_bar ${e}`,!1)},Hue.show_activity_bar=function(){$("#activity_bar_container").css("display","block"),$("#topbox_left_icon").removeClass("fa-caret-up"),$("#topbox_left_icon").addClass("fa-caret-down"),Hue.update_activity_bar(),Hue.apply_theme(),Hue.on_resize()},Hue.hide_activity_bar=function(){$("#activity_bar_container").css("display","none"),$("#topbox_left_icon").removeClass("fa-caret-down"),$("#topbox_left_icon").addClass("fa-caret-up"),Hue.apply_theme(),Hue.on_resize()},Hue.update_activity_bar=function(){if(!Hue.get_setting("activity_bar"))return!1;let e=$("#activity_bar_content");if(0===Hue.activity_list.length)return Hue.clear_activity_bar_items(),$("#activity_bar_no_activity").css("display","block"),!1;$("#activity_bar_no_activity").css("display","none");let i=[];if($(".activity_bar_item").each(function(){let e=$(this).data("username"),t=Hue.get_user_by_username(e);if(t&&Hue.activity_list.some(i=>i.username===e)){let u=Hue.get_user_info_title(t,!0);$(this).attr("title",u),$(this).data("otitle",u),i.push(e)}else $(this).remove()}),Hue.activity_list.length>i.length)for(let t of Hue.activity_list){let u=Hue.get_user_by_username(t.username);if(!i.includes(u.username)&&u){let i=u.profile_image||Hue.config.default_profile_image_url,t=$(`\n                <div class='activity_bar_item dynamic_title'>\n                    <div class='activity_bar_image_container round_image_container action4'>\n                        <img class='activity_bar_image profile_image' src='${i}'>\n                    </div>\n                    <div class='activity_bar_text action'></div>\n                </div>`),s=t.find(".activity_bar_text").eq(0),r=t.find(".activity_bar_image").eq(0);r.on("error",function(){$(this).attr("src")!==Hue.config.default_profile_image_url&&$(this).attr("src",Hue.config.default_profile_image_url)}),r.data("username",u.username),s.text(u.username);let n=Hue.get_user_info_title(u,!0);t.attr("title",n),t.data("otitle",n),t.data("date",u.date_joined),t.data("username",u.username),e.append(t)}}},Hue.push_to_activity_bar=function(e,i){let t=Hue.get_user_by_username(e);if(!t||!Hue.check_permission(t.role,"chat"))return!1;if(i<Date.now()-Hue.config.max_activity_bar_delay)return!1;if(Hue.user_is_ignored(e))return!1;for(let i=0;i<Hue.activity_list.length;i++)if(Hue.activity_list[i].username===e){Hue.activity_list.splice(i,1);break}Hue.activity_list.unshift({username:e,date:i}),Hue.activity_list.length>Hue.config.max_activity_bar_items&&Hue.activity_list.pop(),Hue.check_activity_bar(!1),Hue.started&&Hue.update_activity_bar()},Hue.get_activity_bar_item_by_username=function(e){let i=!1;return $(".activity_bar_item").each(function(){if($(this).data("username")===e)return i=this,!1}),i},Hue.clear_activity_bar_items=function(){$("#activity_bar_content").find(".activity_bar_item").each(function(){$(this).remove()})},Hue.update_activity_bar_image=function(e,i){$("#activity_bar_content").find(".activity_bar_item").each(function(){if($(this).data("username")===e)return $(this).find(".activity_bar_image").eq(0).attr("src",i),!1})},Hue.user_disconnect=function(e){let i,t;Hue.remove_from_userlist(e.user_id),Hue.update_activity_bar();let u=e.disconnection_type;"disconnection"===u?(i=`${e.username} has left`,t="normal"):"pinged"===u?(i=`${e.username} has left (Ping Timeout)`,t="normal"):"kicked"===u?(i=`${e.username} was kicked by ${e.info1}`,t="action"):"banned"===u&&(i=`${e.username} was banned by ${e.info1}`,Hue.ban_list_open&&Hue.request_ban_list(),t="action");let s=Hue.make_info_popup_item({icon:"fas fa-sign-out-alt",message:i,action:!1,type:"user_part"});if("action"===t||!Hue.user_is_ignored(e.username)&&Hue.get_setting("user_part_notifications")){Hue.make_info_popup().show(s)}Hue.open_profile_username===e.username&&Hue.show_profile(e.username,$("#show_profile_image").attr("src"))},Hue.forbidden_user=function(){Hue.feedback("That operation is forbidden on that user")},Hue.announce_new_username=function(e){Hue.replace_property_in_userlist_by_username(e.old_username,"username",e.username);let i=Hue.check_permission(Hue.get_role(e.username),"chat");Hue.username===e.old_username?(Hue.set_username(e.username),i?Hue.show_room_notification(e.username,`${e.old_username} is now known as ${Hue.username}`):Hue.show_room_notification(e.username,`You are now known as ${e.username}`)):i&&Hue.show_room_notification(e.username,`${e.old_username} is now known as ${e.username}`),Hue.admin_list_open&&Hue.request_admin_list()},Hue.user_is_ignored=function(e){return e!==Hue.username&&!!Hue.ignored_usernames_list.includes(e)},Hue.user_not_in_room=function(e){e?Hue.feedback(`${e} is not in the room`):Hue.feedback("User is not in the room")},Hue.get_matching_usernames=function(e){let i=Hue.get_user_by_username(e);if(i)return[i.username];let t=e.split(" "),u=t[0],s=[];for(let e=0;e<t.length;e++)e>0&&(u=`${u} ${t[e]}`),Hue.usernames.includes(u)&&s.push(u);return s},Hue.setup_profile_image=function(e){Hue.profile_image=""===e?Hue.config.default_profile_image_url:e},Hue.setup_show_profile=function(){$("#show_profile_whisper").click(function(){Hue.write_popup_message([$("#show_profile_uname").text()])}),$("#show_profile_edit").click(function(){Hue.show_user_menu()}),$("#show_profile_image").on("error",function(){$(this).attr("src")!==Hue.config.default_profile_image_url&&$(this).attr("src",Hue.config.default_profile_image_url)}),$("#show_profile_hearts_icon").click(function(){Hue.send_badge($("#show_profile_uname").text(),"heart")}),$("#show_profile_skulls_icon").click(function(){Hue.send_badge($("#show_profile_uname").text(),"skull")})},Hue.show_profile=function(e,i){let t,u="Offline",s="",r=0,n=0,a=Hue.get_user_by_username(e),_=!1;if(a&&(u=Hue.get_pretty_role_name(a.role),s=a.bio,r=a.hearts,n=a.skulls,a.username===Hue.username&&(_=!0)),Hue.open_profile_username=e,t=""===i||void 0===i||"undefined"===i?a&&a.profile_image?a.profile_image:Hue.config.default_profile_image_url:i,$("#show_profile_uname").text(e),$("#show_profile_role").text(`(${u})`),$("#show_profile_bio").html(Hue.utilz.make_html_safe(s).replace(/\n+/g," <br> ")).urlize(),$("#show_profile_image").attr("src",t),$("#show_profile_image").data("username",e),a){let e=Hue.get_user_info_title(a);$("#show_profile_image").attr("title",e),$("#show_profile_image").data("otitle",e),$("#show_profile_image").data("date",a.date_joined),$("#show_profile_image").addClass("dynamic_title")}else $("#show_profile_image").attr("title",""),$("#show_profile_image").removeClass("dynamic_title");Hue.can_chat&&Hue.usernames.includes(e)?($("#show_profile_whisper").css("display","block"),$("#show_profile_hearts").css("display","flex"),$("#show_profile_skulls").css("display","flex"),Hue.set_hearts_counter(r),Hue.set_skulls_counter(n)):($("#show_profile_whisper").css("display","none"),$("#show_profile_hearts").css("display","none"),$("#show_profile_skulls").css("display","none")),_?$("#show_profile_edit").css("display","block"):$("#show_profile_edit").css("display","none"),$(".show_profile_button").filter(function(){return"none"!==$(this).css("display")}).length?$("#show_profile_buttons").css("display","flex"):$("#show_profile_buttons").css("display","none"),Hue.msg_profile.show()},Hue.profile_image_changed=function(e){e.username===Hue.username&&(Hue.profile_image=e.profile_image,$("#user_menu_profile_image").attr("src",Hue.profile_image)),Hue.update_user_profile_image(e.username,e.profile_image),Hue.user_is_ignored(e.username)||Hue.show_room_notification(e.username,`${e.username} changed their profile image`),Hue.update_activity_bar_image(e.username,e.profile_image)},Hue.bio_changed=function(e){Hue.replace_property_in_userlist_by_username(e.username,"bio",e.bio),e.username===Hue.username&&Hue.set_bio(e.bio),e.bio&&!Hue.user_is_ignored(e.username)&&Hue.show_room_notification(e.username,`${e.username} changed their bio`)},Hue.reset_voices=function(){if(!Hue.is_admin_or_op(Hue.role))return Hue.not_an_op(),!1;Hue.socket_emit("reset_voices",{})},Hue.remove_ops=function(){if("admin"!==Hue.role)return Hue.feedback("You are not a room admin"),!1;Hue.socket_emit("remove_ops",{})},Hue.announce_voices_resetted=function(e){Hue.show_room_notification(e.username,`${e.username} resetted the voices`),Hue.role.startsWith("voice")&&"voice1"!==Hue.role&&Hue.set_role("voice1"),Hue.reset_voices_userlist()},Hue.announce_removedops=function(e){Hue.show_room_notification(e.username,`${e.username} removed all ops`),"op"===Hue.role&&Hue.set_role("voice1"),Hue.remove_ops_userlist(),Hue.admin_list_open&&Hue.request_admin_list()},Hue.change_role=function(e,i){if(Hue.is_admin_or_op()){if(e.length>0&&e.length<=Hue.config.max_max_username_length){if(e===Hue.username)return Hue.feedback("You can't assign a role to yourself"),!1;if(("admin"===i||"op"===i)&&"admin"!==Hue.role)return Hue.forbidden_user(),!1;if(!Hue.roles.includes(i))return Hue.feedback("Invalid role"),!1;Hue.socket_emit("change_role",{username:e,role:i})}}else Hue.not_an_op()},Hue.announce_role_change=function(e){Hue.username===e.username2&&Hue.set_role(e.role),Hue.show_room_notification(e.username1,`${e.username1} gave ${e.role} to ${e.username2}`),Hue.replace_property_in_userlist_by_username(e.username2,"role",e.role),Hue.admin_list_open&&Hue.request_admin_list()},Hue.set_role=function(e,i=!0){Hue.role=e,Hue.check_permissions(),i&&Hue.config_room_menu()},Hue.ban=function(e){if(Hue.is_admin_or_op()){if(e.length>0&&e.length<=Hue.config.max_max_username_length){if(e===Hue.username)return Hue.feedback("You can't ban yourself"),!1;Hue.socket_emit("ban",{username:e})}}else Hue.not_an_op()},Hue.unban=function(e){if(Hue.is_admin_or_op()){if(e.length>0&&e.length<=Hue.config.max_max_username_length){if(e===Hue.username)return Hue.feedback("You can't unban yourself"),!1;Hue.socket_emit("unban",{username:e})}}else Hue.not_an_op()},Hue.unban_all=function(){Hue.is_admin_or_op()?Hue.socket_emit("unban_all",{}):Hue.not_an_op()},Hue.get_ban_count=function(){Hue.is_admin_or_op()&&Hue.socket_emit("get_ban_count",{})},Hue.receive_ban_count=function(e){let i;i=1===e.count?`There is ${e.count} user banned`:`There are ${e.count} users banned`,Hue.msg_info.show(i)},Hue.kick=function(e){if(Hue.is_admin_or_op()){if(e.length>0&&e.length<=Hue.config.max_max_username_length){if(e===Hue.username)return Hue.feedback("You can't kick yourself"),!1;if(!Hue.usernames.includes(e))return Hue.user_not_in_room(),!1;let i=Hue.get_role(e);if(("admin"===i||"op"===i)&&"admin"!==Hue.role)return Hue.forbidden_user(),!1;Hue.socket_emit("kick",{username:e})}}else Hue.not_an_op()},Hue.announce_ban=function(e){Hue.show_room_notification(e.username1,`${e.username1} banned ${e.username2}`),Hue.ban_list_open&&Hue.request_ban_list()},Hue.announce_unban=function(e){Hue.show_room_notification(e.username1,`${e.username1} unbanned ${e.username2}`),Hue.ban_list_open&&Hue.request_ban_list()},Hue.announce_unban_all=function(e){Hue.show_room_notification(e.username,`${e.username} unbanned all banned users`)},Hue.is_already=function(e,i){"voice1"===i?Hue.feedback(`${e} already has voice 1`):"voice2"===i?Hue.feedback(`${e} already has voice 2`):"voice3"===i?Hue.feedback(`${e} already has voice 3`):"voice4"===i?Hue.feedback(`${e} already has voice 4`):"op"===i?Hue.feedback(`${e} is already an op`):"admin"===i&&Hue.feedback(`${e} is already an admin`)},Hue.start_generic_uname_click_events=function(){$("body").on("click",".generic_uname",function(){let e=$(this).text();Hue.show_profile(e)})},Hue.is_admin_or_op=function(e=!1){let i;return"admin"===(i=e||Hue.role)||"op"===i},Hue.annex=function(e="admin"){if(!Hue.roles.includes(e))return Hue.feedback("Invalid role"),!1;Hue.socket_emit("change_role",{username:Hue.username,role:e})},Hue.after_userlist_filtered=function(){Hue.check_userlist_visibility()},Hue.after_userlist_scroll=function(){Hue.check_userlist_visibility()},Hue.send_badge=function(e,i){if(Hue.send_badge_disabled)return!1;if(e===Hue.username)return!1;return!!Hue.get_user_by_username(e)&&(("heart"===i||"skull"===i)&&(Hue.socket_emit("send_badge",{username:e,type:i}),Hue.send_badge_disabled=!0,void setTimeout(function(){Hue.send_badge_disabled=!1},Hue.config.send_badge_cooldown+100)))},Hue.on_badge_received=function(e){let i,t;e.username===Hue.open_profile_username&&("heart"===e.type?Hue.set_hearts_counter(e.badges):"skull"===e.type&&Hue.set_skulls_counter(e.badges));let u=Hue.get_user_by_username(e.username);if("heart"===e.type&&(i="hearts",t=u.hearts+1),"skull"===e.type&&(i="skulls",t=u.skulls+1),Hue.replace_property_in_userlist_by_username(e.username,i,t),Hue.app_focused){let i=Hue.get_last_chat_message_by_username(e.username);if(i){let t=$(i).find(".chat_profile_image_container").eq(0);Hue.change_profile_image_badge(t,e.type)}}},Hue.change_profile_image_badge=function(e,i){let t;Hue.remove_badge_icons(e),e.addClass(`${i}_badge`),e.addClass("profile_image_badge"),"heart"===i?t="fa fa-heart":"skull"===i&&(t="fa fa-skull"),e.append(`<i class='${t} profile_image_badge_icon ${i}_badge'>`);let u=e.data("badge_feedback_number");u?u+=1:u=1,e.data("badge_feedback_number",u),setTimeout(function(){let i=e.data("badge_feedback_number");if(u!==i)return!1;Hue.remove_badge_icons(e)},Hue.config.badge_feedback_duration)},Hue.remove_badge_icons=function(e){e.removeClass("heart_badge"),e.removeClass("skull_badge"),e.removeClass("profile_image_badge"),e.find(".profile_image_badge_icon").each(function(){$(this).remove()})},Hue.set_hearts_counter=function(e){$("#show_profile_hearts_counter").text(Hue.utilz.format_number(e))},Hue.set_skulls_counter=function(e){$("#show_profile_skulls_counter").text(Hue.utilz.format_number(e))},Hue.get_user_info_title=function(e,i=!1){let t="",u="";return i&&(u=`${e.username}\n`),e.last_message&&(t=`Last Message: ${e.last_message.substring(0,100)}\n`),`${u}${t}${`Joined: ${Hue.utilz.nice_date(e.date_joined)}`}`},Hue.push_to_all_usernames=function(e){e&&(Hue.all_usernames.includes(e)||(Hue.all_usernames.push(e),Hue.all_usernames.length>1e3&&Hue.all_usernames.shift()))};
