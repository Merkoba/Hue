...
var Scrambler=function(){"use strict";function t(e){return(t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(e)}function e(t){return function(t){if(Array.isArray(t)){for(var e=0,r=new Array(t.length);e<t.length;e++)r[e]=t[e];return r}}(t)||function(t){if(Symbol.iterator in Object(t)||"[object Arguments]"===Object.prototype.toString.call(t))return Array.from(t)}(t)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance")}()}function r(r){if(o(r)||a(r))return!1;var c=n(r)||"object"===t(r);return c&&(r.target=void 0!==r.target&&c?r.target:"[data-scrambler]",r.random=void 0!==r.random&&c?r.random:[1e3,3e3],r.speed=void 0!==r.speed&&c?r.speed:100,r.text=!(void 0===r.text||!c)&&r.text),e(c?document.querySelectorAll(r.target):document.querySelectorAll(r)).forEach(function(t){if("true"!==t.getAttribute("data-scramble-active")){t.setAttribute("data-scramble-active","true");var e=t.textContent.split(""),o=t.innerHTML,a=e,c=t.textContent.split(""),f=[],l=r.speed?r.speed:100,s=!1,d=function(r){var n=r||t.textContent;e=n.split(""),c=n.split("");var o=[];e.forEach(function(t,r){" \t\n\r\v".indexOf(e[r])>-1?o.push(" "):o.push(i())}),a=o};r.text&&""!==r.text&&("string"==typeof r.text||r.text instanceof String)?(d(r.text),s=!0):t.getAttribute("data-scramble-text")&&""!==t.getAttribute("data-scramble-text")&&(d(t.getAttribute("data-scramble-text")),s=!0);var b=setInterval(function(){if(a.map(function(o,a){return!(" \t\n\r\v".indexOf(o)>-1||(c[a]=i(),setTimeout(function(){f[a]=!0},u(n(r),r.random)),!0===f[a]&&(c[a]=e[a]),t.textContent=c.join(""),0))}),c.length===e.length&&c.every(function(t,r){return t===e[r]})){if(t.innerHTML=o,s){var l=t.children[0];l&&""!==l?l.textContent=c.join(""):t.textContent=c.join("")}clearInterval(b),t.setAttribute("data-scramble-active","false")}},l)}}),!0}var n=function(t){return!!t&&t.constructor===Object},o=function(t){return!!t&&t.constructor===Array},a=function(t){return"boolean"==typeof t},i=function(t,e){var r=t||1,n=e||!1,o=Math.random().toString(36).replace(/[^a-z]+/g,"").substr(0,r);return" \t\n\r\v".indexOf(o)<0&&!0!==n&&o},u=function(t,e){return t&&o(e)&&e.length>1?e[0]+(Math.random()*(1-e[1])+e[1]):-2999*Math.random()+3e3+1e3};return r}();
