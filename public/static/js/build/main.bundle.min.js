...
Hue.show_help=function(){let e=Hue.template_help();Hue.msg_info2.show(["Help",e])},Hue.copy_string=function(e,t=!0){let o=document.createElement("textarea");document.body.appendChild(o),o.value=e,o.select(),document.execCommand("copy"),document.body.removeChild(o),t&&Hue.play_audio("pup2")},Hue.error_occurred=function(){Hue.feedback("An error occurred")},Hue.needs_confirm=function(e,t=!1){t||(t="Are you sure?"),confirm(t)&&Hue[e]()},Hue.show_credits=function(){Hue.msg_credits.show(function(){Hue.credits_audio?(Hue.credits_audio.currentTime=0,Hue.credits_audio.play()):(Hue.credits_audio=new Audio,Hue.credits_audio.src=Hue.config.credits_audio_url,Hue.credits_audio.setAttribute("loop",!0),Hue.credits_audio.play())})},Hue.show_console_message=function(){console.info("%c🤔 Want to work with us? It's pretty much 99.99% risks, some negligible fraction AI, a couple bureaucracies to keep people minimally pissed off, and a whole lot of creativity.","font-size:1.4rem")},Hue.generate_favicon=function(e){let t;if("default"===e)t="#C06DCF";else if("alert_1"===e)t="#4AB3DD";else{if("alert_2"!==e)return;t="#DD4A66"}let o=document.createElement("canvas");o.height=256,o.width=256;let i=o.getContext("2d"),u=o.height/2;i.fillStyle="rgb(16,16,16)",i.fillRect(u-97,u-97,194,194),i.fillStyle=t,i.fillRect(u-96,u-96,192,192);let c=document.querySelector("link[rel*='icon']")||document.createElement("link");c.type="image/x-icon",c.rel="shortcut icon",c.href=o.toDataURL(),document.getElementsByTagName("head")[0].appendChild(c)};
