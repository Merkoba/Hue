...
Hue.setup_footer_icons=function(){let e=["image","tv","radio"];for(let o of e)"disabled"===Hue[`room_${o}_mode`]?$("#footer_image_controls").css("display","none"):$("#footer_image_controls").css("display","flex"),Hue[`can_${o}`]?$(`#footer_${o}_icon_container`).css("display","flex"):$(`#footer_${o}_icon_container`).css("display","none");"disabled"===Hue.room_image_mode||"disabled"===Hue.room_tv_mode?$("#footer_media_rotate").css("display","none"):$("#footer_media_rotate").css("display","flex"),Hue.update_footer_separators()},Hue.setup_footer=function(){$("#footer_image_icon").on("auxclick",function(e){2===e.which&&$("#image_file_picker").click()}),$("#footer_user_menu_container").on("auxclick",function(e){2===e.which&&(Hue.clear_show_reactions_box(),Hue.show_global_settings())}),$("#footer_media_menu_container").on("auxclick",function(e){2===e.which&&Hue.stop_media()}),$("#footer_media_rotate").click(function(){if(Hue.num_media_elements_visible()<2)return!1;Hue.swap_media_layout()}),$("#footer_media_rotate").on("auxclick",function(e){if(Hue.num_media_elements_visible()<2)return!1;2===e.which&&Hue.swap_display_positions_2()});let e=["image","tv","radio"];for(let o of e)$(`#${o}_lock_area`).click(function(){Hue.change_media_lock({type:o,feedback:!0})})},Hue.check_footer_media_rotate=function(){Hue.num_media_elements_visible()<2?$("#footer_media_rotate").addClass("faded"):$("#footer_media_rotate").removeClass("faded")},Hue.update_footer_separators=function(){Hue.horizontal_separator.separate("footer_media_items")};
Hue.update_header_separators=function(){Hue.horizontal_separator.separate("header_items_inner")},Hue.setup_header=function(){Hue.horizontal_separator.separate("header_radio"),$("#header_radio_volume_area").on("auxclick",function(e){2===e.which&&(0!==Hue.room_state.radio_volume?Hue.set_radio_volume(0):Hue.set_radio_volume(1))})};
