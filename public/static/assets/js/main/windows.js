...
Hue.close_all_popups = (callback = false) => {
...
// Creates a Msg popup
Hue.create_popup = (args = {}, ptype = `unset`) => {
  if (!args.id) {
    Hue.popup_id += 1
...
Hue.get_first_visible_modal_item = (id) => {
...
Hue.hide_windows_temporarily = (delay = 2000) => {
