...
Hue.setup_theme = () => {
  ...
  Hue.ev(Hue.el(`#background`), `error`, () => {
    if (Hue.background_preview) {
...
Hue.apply_theme = (background_color = ``, text_color = ``) => {
  if (!background_color) {
...
Hue.apply_selected_theme = () => {
  ...
  Hue.show_confirm(`Apply selected theme`, () => {
...
Hue.setup_theme_picker = () => {
  Hue.ev(Hue.el(`#theme_picker_random`), `click`, () => {
    Hue.generate_random_themes()
  })

  Hue.ev(Hue.el(`#theme_picker_peek`), `click`, () => {
    Hue.hide_windows_temporarily()
  })
}
...
Hue.set_background = (data, apply = true) => {
  if (!data.background) {
    Hue.background = ``
  }
  else {
...
Hue.apply_background = (background = Hue.background, preview = false) => {
...
Hue.set_background_color = (color) => {
...
Hue.change_background_color = (color) => {
...
Hue.show_background_peek_confirm = () => {
  Hue.show_confirm(`Apply selected background`, () => {
    Hue.background_peek_action()
